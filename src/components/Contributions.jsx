            ...
            <Row>
                ...
                <Col md={10}  >
                    <div className='d-flex justify-content-between mb-2 '>
                        ...
                        <p className='m-0 text-warning' style={{ fontSize: "13px" }}>Contribution settings <FontAwesomeIcon icon={faAngleDown} className='fa-sm' /></p>
                    </div>
                        ...
                        <div>
                            ...
                            <div style={{ display: 'flex', marginLeft: "10px" }}>
                                {months.map((month, index) => (
                                    <div key={index} style={{ fontSize: "13px", marginLeft: '32px' }}>{month}</div>
                                ))}
                            </div>

                            {/* Display the grid */}
                            <div style={{ display: 'flex', marginTop: '10px' }} className='m-0'>
                                ...
                                {contributions.map((week, weekIndex) => (
                                    <div key={weekIndex} style={{ marginRight: '2px' }}>
                            ...
                            <div className='d-flex justify-content-between align-items-center '>
                                <p style={{ fontSize: "12px" }} className='text-warning ms-3 mt-2 '>Learn how we count contributions</p>
                                <div className='d-flex align-items-center'>
                                    <span style={{ fontSize: '12px', marginRight: '5px' }}>Less</span>
                                    <div className='d-flex'>
                                        <div style={{ width: '10px', height: '10px', backgroundColor: 'rgb(255 255 255 / 5%)', margin: '0 2px', borderRadius: '2px' }}></div>
                                        <div style={{ width: '10px', height: '10px', backgroundColor: '#9be9a8', margin: '0 2px', borderRadius: '2px' }}></div>
                                        <div style={{ width: '10px', height: '10px', backgroundColor: '#40c463', margin: '0 2px', borderRadius: '2px' }}></div>
                                        <div style={{ width: '10px', height: '10px', backgroundColor: '#30a14e', margin: '0 2px', borderRadius: '2px' }}></div>
                                        <div style={{ width: '10px', height: '10px', backgroundColor: '#216e39', margin: '0 2px', borderRadius: '2px' }}></div>
                                    </div>
                                    <span style={{ fontSize: '12px', marginLeft: '5px' }}>More</span>
                                </div>
                            </div>
                        </div>
                    </div>
